...
//                 </div>
//                 <button
//                   className="btn__checkout btn no-cursor"
...
//     // Implement your purchase logic here, such as making an API call, updating a database, etc.
//     // For this example, we'll just toggle the purchase state.
...
//   const handleBuyClick = () => {
//     // Implement your purchase logic here (API calls, database updates, etc.)
//     // For simplicity, we'll just toggle the purchase state.
//     setPurchased(!isPurchased);
//   };
...
//                 >
//                   {isPurchased ? 'Thanks for your order!' : 'Checkout'}
//                 </button>
//               </div>
//             )}
//           </div>
